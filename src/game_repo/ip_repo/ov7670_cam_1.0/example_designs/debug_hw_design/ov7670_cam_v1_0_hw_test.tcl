# Runtime Tcl commands to interact with - ov7670_cam_v1_0

# Sourcing design address info tcl
set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
source ${bd_path}/ov7670_cam_v1_0_include.tcl
...
proc get_done_and_error_bit { rdata totmaster position } {
	...
	set DE [string range $bindata [ expr $position * 2 ] [expr $position * 2 + 1] ]
	return $DE
}
...
if { $DE == 10 } {
	...
	puts "Data comparison test fail for - M00_AXI, rdata-$rdata_tmp expected-10 actual-$DE"
	inc ec
}
